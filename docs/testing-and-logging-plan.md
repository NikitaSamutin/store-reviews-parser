...
### Этап 4: Написать failing-тесты для P1
- [ ] validation.test.ts — тесты на лимиты
- [ ] cors.test.ts — тесты на CORS

### Этап 5: Исправить P1, проверить тестами

### Этап 6: P2/P3 тесты и исправления
- [ ] csv-injection.test.ts
- [ ] Остальные тесты
