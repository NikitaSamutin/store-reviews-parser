...
**План исправления:**
- [ ] Реализовать динамический импорт sqlite3
- [ ] Добавить лимит на размер `memReviews` (fallback режим)
- [ ] Реализовать пагинацию без копирования всего массива
...
**План исправления:**
- [ ] Добавить middleware для rate-limiting (express-rate-limit)
...
**План исправления:**
- [ ] Установить максимальный `limit` (например, 1000)
- [ ] Установить максимальный `total` для экспорта (например, 10000)
- [ ] Реализовать стриминг для больших экспортов
- [ ] Добавить валидацию числовых параметров
