    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div>
            <label className="block text-xs text-gray-500 mb-1">С месяца</label>
            <Select
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1">С года</label>
            <Select
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1">По месяц</label>
            <Select
          ...
          <div>
            <label className="block text-xs text-gray-500 mb-1">По год</label>
            <Select
